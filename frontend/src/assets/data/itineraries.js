// Itineraries data for India destinations
export const itineraries = [
  {
    ...
    journey: {
      day1: "Visit Devi Talab Mandir, explore local bazaars, traditional Punjabi lunch, evening at Wonderland Theme Park",
      day2: "Gurdwara visits, Punjab Agricultural University tour, shopping for Phulkari textiles, farewell dinner"
    },
    price: 3200,
    maxGroupSize: 15,
    category: "Cultural"
  },
  {
    ...
    journey: {
      day1: "Ram Mandir darshan, Hanuman Garhi visit, Kanak Bhawan temple, evening Sarayu Aarti",
      day2: "Treta Ke Thakur temple, Nageshwarnath temple, Ram Ki Paidi, spiritual discourse and departure"
    },
    price: 2800,
    maxGroupSize: 20,
    category: "Spiritual"
  },
  {
    ...
    journey: {
      day1: "Early morning Tirumala darshan, TTD museum visit, evening local temple tour",
      day2: "Padmavathi Temple visit, Sri Venkateswara Zoological Park, shopping for prasadam and departure"
    },
    price: 4200,
    maxGroupSize: 12,
    category: "Spiritual"
  },
  {
    ...
    journey: {
      day1: "Ajmer Sharif Dargah visit, Taragarh Fort exploration, Ana Sagar Lake sunset",
      day2: "Adhai Din Ka Jhonpra, Nasiyan Jain Temple, local handicraft shopping, Sufi qawwali evening"
    },
    price: 3600,
    maxGroupSize: 18,
    category: "Heritage"
  ...
  {
    id: "itin-5",
    title: "Vijayapura in a blink: a 2-day escape",
    ...
    journey: {
      day1: "Gol Gumbaz and whispering gallery experience, Ibrahim Rauza visit, local cuisine lunch",
      day2: "Bara Kaman ruins, Malik-e-Maidan cannon, Jami Masjid, cultural center visit"
    },
    price: 2900,
    maxGroupSize: 16,
    category: "Heritage"
  },
  {
    ...
    journey: {
      day1: "Golden Temple morning visit, langar participation, Jallianwala Bagh memorial, evening palki ceremony",
      day2: "Durgiana Temple, local market exploration, Wagah Border ceremony, heritage walk"
    },
    price: 3800,
    maxGroupSize: 20,
    category: "Spiritual"
  ...
  {
    id: "itin-7",
    title: "Gulmarg meadows adventure",
    destination: "Gulmarg",
    ...
    journey: {
      day1: "Arrival and Gulmarg Gondola Phase 1, meadow walks, photography session",
      day2: "Gondola Phase 2 to Apharwat Peak, snow activities, local cuisine experience",
      day3: "St. Mary's Church visit, golf course exploration, shopping for Kashmiri handicrafts"
    },
    price: 5500,
    maxGroupSize: 10,
    category: "Adventure"
  ...
  {
    id: "itin-8",
    title: "Meenakshi Temple divine experience",
    destination: "Madurai", 
    region: "Tamil Nadu",
    duration: "2 Days",
    ...
    journey: {
      day1: "Meenakshi Temple complex tour, thousand pillar hall visit, evening aarti ceremony",
      day2: "Thirumalai Nayak Palace, Gandhi Memorial Museum, local silk shopping, traditional dance performance"
    },
    price: 3400,
    maxGroupSize: 18,
    category: "Cultural"
  ...
  {
    id: "itin-9",
    title: "Mysuru royal heritage trail",
    destination: "Mysuru",
    region: "Karnataka", 
    duration: "2 Days",
    ...
    journey: {
      day1: "Mysore Palace tour, Chamundeshwari Temple visit, Chamundi Hills scenic drive",
      day2: "Brindavan Gardens musical fountain, Jaganmohan Palace Art Gallery, sandalwood shopping"
    },
    price: 3100,
    maxGroupSize: 16,
    category: "Heritage"
  ...
  {
    id: "itin-10",
    title: "Anjuna Beach Goa paradise",
    destination: "Anjuna", 
    region: "Goa",
    duration: "3 Days",
    ...
    journey: {
      day1: "Beach relaxation, water sports, sunset viewing, local seafood dinner",
      day2: "Anjuna Flea Market, Chapora Fort visit, spice plantation tour",
      day3: "Old Goa churches tour, local village experience, beachside farewell party"
    },
    price: 4800,
    maxGroupSize: 12,
    category: "Adventure"
